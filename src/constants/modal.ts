...
export const createDream = `
  ...
  <p>Creating a story costs 10 credits and must comply with our <a href="${NAV_ROUTES.CONTENT_POLICY}" target="_blank">Content Policy</a>. By creating a story, you agree to these terms.</p>
`;
