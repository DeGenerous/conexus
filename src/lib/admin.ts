...
class AdminApp {
   ...
   * @param body - The contract details to persist.
   */
   ...
   * @param contractId - The identifier of the contract to delete.
   */
  ...
  /**
   * Create a token-based gate for a collection.
   * @param name - Human readable gate name.
   * @param contract_id - Contract backing the gate.
   * @param min_amount - Minimum token amount required.
   */
  ...
  /**
   * Create a class-based gate for a collection.
   * @param contract_id - Contract backing the gate.
   * @param class_name - Class label for the gate.
   * @param token_id_min - Minimum token id allowed.
   * @param token_id_max - Maximum token id allowed.
   */
  ...
  /**
   * Delete a gate associated with a collection.
   * @param gateId - The identifier of the gate to delete.
   */
  ...
  /**
   * Retrieve details for a specific gate.
   * @param gateId - The identifier of the gate to fetch.
