...
describe('AdminAPI', () => {
    ...
    it('listAccounts calls correct endpoint', async () => {
        ...
        expect(mockRequest).toHaveBeenCalledWith('/admin/accounts?page=1&page_size=10');
    });
    ...
    it('accountTopN calls correct endpoint and payload', async () => {
        ...
        expect(mockRequest).toHaveBeenCalledWith('/admin/metrics/top-n/active-accounts', {
            method: 'POST',
            body: JSON.stringify(filter),
        });
    });
    ...
    it('topicTopN calls correct endpoint and payload', async () => {
        ...
        expect(mockRequest).toHaveBeenCalledWith('/admin/metrics/top-n/played-topics', {
            method: 'POST',
            body: JSON.stringify(filter),
        });
    });
