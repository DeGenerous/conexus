...
describe('AgentAPI', () => {
  ...
  it('calls start with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/start', {
      method: 'POST',
  ...
  it('calls delete with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/story123', {
      method: 'DELETE',
    });
  ...
  it('calls respond with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/respond', {
      method: 'POST',
  ...
  it('calls step with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/step', {
      method: 'POST',
  ...
  it('calls stepImage with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/step/image', {
      method: 'POST',
      body: JSON.stringify({ story_id, step_id }),
    });
    expect(result).toBe(mockData);
  ...
  it('calls generateImage with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/generate-image', {
      method: 'POST',
      body: JSON.stringify({ story_id }),
    });
    expect(result).toBe(mockData);
  ...
  it('calls imageStatus with correct params', async () => {
    ...
    expect(api.request).toHaveBeenCalledWith('/agent/story/image-status', {
      method: 'POST',
