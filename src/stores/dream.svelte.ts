...
const DEFAULT_TABLE_PROMPT: TablePrompt = {
  premise: '',
  environment: '',
  exposition: '',
  first_action: '',
...
export const defaultTablePrompt = (): TablePrompt =>
  structuredClone(DEFAULT_TABLE_PROMPT);

export const tablePrompt = writable<TablePrompt>(defaultTablePrompt());
